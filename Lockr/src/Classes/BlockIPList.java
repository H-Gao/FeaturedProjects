...
public class BlockIPList extends JFrame implements MouseListener, MouseMotionListener
{
	...
	public BlockIPList(ControlPanel c)
	{
	...
	public void createInfo(String path)
	{
	...
	public class BlockedInfo
	{
		...
		public BlockedInfo(BlockIPList bl, String path)
		{
			icon = new JLabel();
