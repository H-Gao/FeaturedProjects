...
def test_mixed_big_block():
    ...
    assert board.flatten() == [[r, g],
                               [r, r]]

    board.rotate(1)

    assert board.flatten() == [[g, r],
                               [r, r]]
